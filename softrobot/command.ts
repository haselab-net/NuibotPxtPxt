namespace softrobot.command {
    export enum CommandId {
        ...
        CI_SETPARAM = 9,            //9 Set parameter.
        CI_RESET_SENSOR = 10,       //10 Reset sensor.
        CI_NCOMMAND = 11,
        CIU_TEXT = 11,          	//11 return text message: cmd, type, length, bytes
        CIU_SET_IPADDRESS = 12,		//12 Set ip address to return the packet
        CIU_GET_IPADDRESS = 13,     //13 Get ip address to return the packet
        CIU_GET_SUBBOARD_INFO = 14, //14 Get sub board info
        CIU_MOVEMENT = 15,          //15 commands related to movement control 
        CIU_NCOMMAND = 15,          //15 number of commands
